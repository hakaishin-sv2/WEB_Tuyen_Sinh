            ...
            <div class="card shadow mb-4">
              ...
              <div class="card-body">
                ...
                <form action="" method="POST">
                    <div class="mb-3 mt-3">
                        <label for="name_tag_new" class="form-lable">Tên Tag Mới: </label>
                        <input type="text" class="form-control" id="name_tag_new" name="name_tag_new" value="<?= htmlspecialchars($tag_item["name_tag"], ENT_QUOTES, 'UTF-8') ?>">
                    </div>
