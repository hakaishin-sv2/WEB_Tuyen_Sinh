<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <!-- <li class="nav-item">
        ...
        <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                ...
                <a class="collapse-item" href="index.php?act=login">Login</a>
                <a class="collapse-item" href="index.php?act=login">Register</a>
                <a class="collapse-item" href="index.php?act=forgot-password">Forgot Password</a>
    ...
    <!-- <li class="nav-item">
        ...
        <div id="collapsePostsManager" class="collapse" aria-labelledby="headingPostsManager" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
 ...
 -->
    ...
    <li class="nav-item">
        ...
        <div id="collapseUser" class="collapse" aria-labelledby="headingUser" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                ...
                <a class="collapse-item" href="index.php?act=users">Danh sách user</a>
                <a class="collapse-item" href="index.php?act=user-create">Thêm mới user</a>
            </div>
        </div>
    </li>
    ...
    <div class="sidebar-card d-none d-lg-flex">
        <img class="sidebar-card-illustration mb-2" src="view/img/undraw_rocket.svg" alt="...">
