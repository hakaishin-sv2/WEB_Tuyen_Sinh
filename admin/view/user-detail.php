...
<html lang="en">
  ...
  <body id="page-top">
            ...
            <td>
                ...
                if ($key == "password") {
                  ...
                  if ($value == 1) {
                    ...
                    echo '<span class="badge badge-primary">Người viết bài</span>';
                  }else {
    ...
    <?php endforeach; ?>
                ...
                <a href="index.php?act=users" class="btn btn-danger">Quay lại</a>
                <a href="index.php?act=user-update&id=<?= isset($_GET['id']) ? $_GET['id'] : '' ?>" class="btn btn-warning">Update</a>
