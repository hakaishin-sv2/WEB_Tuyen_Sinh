...
<html lang="en">
  ...
  <body id="page-top">
    ...
    <tr>
        <td>Full Name</td>
        <td><?php echo $author_item['full_name']; ?></td>
    </tr>
    <tr>
        <td>Email</td>
        <td><?php echo $author_item['email']; ?></td>
    </tr>
    <tr>
        <td>Avatar</td>
        <td><img src="<?php echo $author_item['avatar']; ?>" alt="Avatar" class="rounded-circle" style="width: 100px; height: 100px;"></td>
    </tr>
    <tr>
        <td>Tiểu sử</td>
        <td><?php echo $author_item['Tieusu']; ?></td>
    </tr>
<?php else: ?>
    <tr>
...
<?php endif; ?>
                ...
                <a href="index.php?act=authors" class="btn btn-danger">Quay lại</a>
                <a href="index.php?act=author-update&id=<?= isset($_GET['id']) ? $_GET['id'] : '' ?>" class="btn btn-warning">Update</a>
                <a href="index.php?act=author-update&id=<?= isset($_GET['id']) ? $_GET['id'] : '' ?>" class="btn btn-success">Xem tất cả bài viết</a>
              </div>
            </div>
          </div>
          <!-- /.container-fluid -->
