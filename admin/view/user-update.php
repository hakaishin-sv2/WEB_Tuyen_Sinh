    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          <!-- Page Heading -->
          <h1 class="h3 mb-2 text-gray-800">Update mới user</h1>
          <!-- <p class="mb-4">
          ...
          <div class="card shadow mb-4">
            ...
            <div class="card-body">
              ...
              <form action="" method="POST">
                <div class="mb-3 mt-3">
                  <label for="full_name" class="form-lable">full_name: </label>
                  <input type="text" class="form-control" id="full_name" name="full_name" value="<?= htmlspecialchars($user_item["full_name"], ENT_QUOTES, 'UTF-8') ?>">
                </div>
                <div class="mb-3 mt-3">
                  <label for="email" class="form-lable">Email: </label>
                  <input type="email" class="form-control" id="email" name="email" value=<?= $user_item["email"] ?>>
                </div>
                <!-- <div class="mb-3 mt-3">
                        <label for="username" class="form-lable">username: </label>
                        <input type="text"  class="form-control" id="username" name="username" value=<?= $user_item["username"] ?>>
                    </div> -->
                <div class="mb-3 mt-3">
                  <label for="password" class="form-lable">password: </label>
                  <input readonly type="password" class="form-control" id="password" name="password" value=<?= $user_item["password"] ?>>
                </div>
                <div class="mb-3 mt-3">
                  <label for="role" class="form-lable">Vai trò: </label>
                  <select name="role" id="role" class="form-control">
                    <option value="admin" <?= ($user_item["role"] === "admin") ? 'selected' : '' ?>>Admin</option>
                    <option value="teacher" <?= ($user_item["role"] === "teacher") ? 'selected' : '' ?>>Người xét duyệt</option>
                    <option value="student" <?= ($user_item["role"] === "student") ? 'selected' : '' ?>>User</option>
                  </select>
                </div>
