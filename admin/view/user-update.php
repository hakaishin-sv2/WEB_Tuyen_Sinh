              ...
              <div class="card-body">
                ...
                <form action="" method="POST">
                    ...
                    <div class="mb-3 mt-3">
                        ...
                        <input type="password"  class="form-control" id="password" name="password" value=<?=$user_item["password"] ?>>
                    </div>
                    <div class="mb-3 mt-3">
                        <label for="role" class="form-lable">Vai trò: </label>
                        <select name="role" id="role" class="form-control">
                            <option value="1" <?= ($user_item["role"] == 1) ? 'selected' : '' ?>>Admin</option>
                            <option value="0" <?= ($user_item["role"] == 0) ? 'selected' : '' ?>>Member</option>
                            <option value="2" <?= ($user_item["role"] == 2) ? 'selected' : '' ?>>Người Kiểm duyệt</option>
                            <option value="3" <?= ($user_item["role"] == 3) ? 'selected' : '' ?>>Người post bài</option>
                        </select>
                    </div>
