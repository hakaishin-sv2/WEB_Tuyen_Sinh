          ...
          <div class="container-fluid">
            ...
            <div class="card shadow mb-4">
              ...
              <table class="table">
                ...
                <?php foreach($category_item as $key => $value): ?>
                <tr>
                    <td><?php echo $key; ?></td>
                    <td>
                        <?php 
                ...
                <a href="index.php?act=categories" class="btn btn-danger">Quay lại</a>
                <a href="index.php?act=category-update&id=<?= isset($_GET['id']) ? $_GET['id'] : '' ?>" class="btn btn-warning">Update</a>
