        ...
        <div class="col-md-6">
            ...
            <div class="form-group">
                ...
                <select name="select_category" id="select_category" class="form-control" >
                    ...
                    <?php print_r($post_item); foreach($categories as $categr): ?>
        ...
        <div class="col-md-6">
            ...
            <div class="form-group">
                ...
                <select name="is_trending" id="is_trending" class="form-control" required>
                    <option value="0" <?= $post_item['status'] = 0 ? 'selected' : '' ?>>No</option>
                    <option value="1" <?= $post_item['status'] = 1 ? 'selected' : '' ?>>Yes</option>
                </select>
            </div>
        </div>
        <div class="col-12">
            <div class="form-group">
                ...
                <textarea  class="form-control" id="content" name="content" rows="3" ><?=$post_item["content"]?></textarea>
            </div>
        </div>
        <div class="col-12">
