...
<?php if (!empty($post_dto_item)): ?>
    ...
    <tr>
        <td>Status</td>
        <td><?php echo $post_dto_item['status'] == 1 ? 'Đã public' : 'Chờ phê duyệt'; ?></td>
    </tr>
    <tr>
        <td>Is Trending</td>
        <td>
    ...
    <tr>
        <td>Phê duyệt by</td>
        <td><?php echo !empty($post_dto_item['pheduyet_name']) ? htmlspecialchars($post_dto_item['pheduyet_name']) : 'Chưa được phê duyệt'; ?></td>
    </tr>
<?php else: ?>
    <tr>
