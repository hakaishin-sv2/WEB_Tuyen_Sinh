...
<html lang="en">
  <head>
    ...
    <title>SB Admin 2 - ADD Danh Mục</title>
            ...
            <div class="card shadow mb-4">
              ...
              <div class="card-body">
                ...
                <form action="" method="POST">
                    <div class="mb-3 mt-3">
                        <label for="name_category" class="form-lable">Ctegory Name: </label>
                        <input type="text" class="form-control" id="name_category" name="name_category" 
                        value="<?= isset($_SESSION['data_err']['name_category']) ? htmlspecialchars($_SESSION['data_err']['name_category'], ENT_QUOTES, 'UTF-8') : '' ?>">
                    </div>
