        ...
        <form action="" method="post" enctype="multipart/form-data">
            <div class="form-group">
                ...
                <?php foreach ($users as $user): ?>
                    <option value="<?= $user['id'] ?>" <?= ($user['id'] == $author_item['user_id']) ? 'selected' : '' ?>>
            ...
            <div class="form-group">
            <img id="avatar-preview" src="<?= isset($author_item['avatar']) ? $author_item['avatar'] : '' ?>" alt="Ảnh Avatar" style="max-width: 200px; max-height: 200px; <?= isset($author_item['avatar']) ? '' : 'display: none;' ?>">
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control" id="bio" name="bio" rows="3" required><?= $author_item["Tieusu"]; ?></textarea>
            </div>
