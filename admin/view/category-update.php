            ...
            <div class="card shadow mb-4">
              ...
              <div class="card-body">
                ...
                <form action="" method="POST">
                    <div class="mb-3 mt-3">
                        <label for="name_category_new" class="form-lable">Tên Danh Mục Mới: </label>
                        <input type="text" class="form-control" id="name_category_new" name="name_category_new" value="<?= htmlspecialchars($category_item["name_category"], ENT_QUOTES, 'UTF-8') ?>">
                    </div>
