...
<body id="page-top">
    ...
    <!-- Page level plugins -->
    <script src="View/dashboard_client/vendor/chart.js/Chart.min.js"></script>

    <!-- Page level custom scripts -->
    <script src="View/dashboard_client/js/demo/chart-area-demo.js"></script>
    <script src="View/dashboard_client/js/demo/chart-pie-demo.js"></script>
