            ...
            <div class="card shadow mb-4">
              ...
              <div class="card-body">
                ...
                <form action="" method="POST">
                    <div class="mb-3 mt-3">
                        <label for="name_tag" class="form-lable">Tag Name: </label>
                        <input type="text" class="form-control" id="name_tag" name="name_tag" 
                        value="<?= isset($_SESSION['data_err']['name_tag']) ? htmlspecialchars($_SESSION['data_err']['name_tag'], ENT_QUOTES, 'UTF-8') : '' ?>">
                    </div>
