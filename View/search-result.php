            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-9">
                        ...
                        <h5 class="comment-title py-4"><?php echo $total_posts; ?> kết quả được tìm thấy với từ khóa là: <?= $_GET["search"] ?? " " ?></h5>
                        <?php
                        ...
                        <div class="text-start py-4">
                            <div class="custom-pagination">
                                ...
                                if ($page > 1) : ?>
                                    <a href="index.php?act=searchresult&search=<?php echo $search; ?>&page=<?php echo $page - 1; ?>" class="prev">Previous</a>
                                <?php endif; ?>
                                <?php for ($i = 1; $i <= $total_pages; $i++) : ?>
                                    <a href="index.php?act=searchresult&search=<?php echo $search; ?>&page=<?php echo $i; ?>" class="<?php echo $i == $page ? 'active' : ''; ?>"><?php echo $i; ?></a>
                                <?php endfor; ?>
                                <?php if ($page < $total_pages) : ?>
                                    <a href="index.php?act=searchresult&search=<?php echo $search; ?>&page=<?php echo $page + 1; ?>" class="next">Next</a>
                                <?php endif; ?>
                            </div>
                        </div>
