                ...
                <div class="form-section">
                    ...
                    <form action="" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input type="tel" class="form-control" id="phone" name="phone" placeholder="Nhập số điện thoại" value="<?= isset($_SESSION['data_errors']['phone']) ? htmlspecialchars($_SESSION['data_errors']['phone']) : '' ?>" required>
                        </div>
                        <!-- <div class="form-group">
